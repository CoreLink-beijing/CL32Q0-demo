...
#define FLAGS_STR "-O3 -fno-common -funroll-loops -finline-functions -falign-functions=4 -falign-jumps=4 -falign-loops=4"
...
//inline void portable_init(core_portable *p, int *argc, char *argv[]) {}
void portable_init(core_portable *p, int *argc, char *argv[]);
inline void portable_fini(core_portable *p) {}
